 ...
 *
 * Same members as `FetchOptionsType` except `body`, which accepts any pre-serialization
 * value here (auto-serialized to JSON if object/array; raw string/Buffer sent as-is) rather
 * than the narrower post-serialization union `FetchOptionsType.body` carries.
 */
...
export type BodyRequestOptionsType = {
  /**
