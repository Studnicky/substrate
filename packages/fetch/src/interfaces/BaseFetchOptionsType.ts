/**
 * Base fetch options type (without interceptors to avoid circular dependencies)
 */

/**
 * Base fetch options with timeout and abort controller support
 * Does not include interceptor properties to break circular dependency with interceptor types
 */
export type BaseFetchOptionsType = {
  /**
