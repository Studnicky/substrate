...
describe('Channel', () => {
  it('publish then subscribe yields buffered items', async () => {
  ...
  it('subscribe receives items published after subscription starts', async () => {
  ...
  it('close() terminates subscribe', async () => {
    const ch = new Channel<number>();
