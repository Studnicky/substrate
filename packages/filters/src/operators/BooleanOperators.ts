...
export class BooleanOperators {
  ...
  static handleEquals(value: FilterValueEntity.Type, filterValue: FilterValueEntity.Type) {
    ...
    if (typeof filterValue !== 'boolean') {
      throw new FilterOperatorError(`BOOLEAN.EQUALS requires filter value to be a boolean, got ${typeof filterValue}`, { 'operator': 'BOOLEAN.EQUALS' });
    }
  ...
  static handleIdentical(value: FilterValueEntity.Type, filterValue: FilterValueEntity.Type) {
    ...
    if (typeof filterValue !== 'boolean') {
      throw new FilterOperatorError(`BOOLEAN.IDENTICAL requires filter value to be a boolean, got ${typeof filterValue}`, { 'operator': 'BOOLEAN.IDENTICAL' });
    }
  ...
  static handleNotEquals(value: FilterValueEntity.Type, filterValue: FilterValueEntity.Type) {
    ...
    if (typeof filterValue !== 'boolean') {
      throw new FilterOperatorError(`BOOLEAN.NOT_EQUALS requires filter value to be a boolean, got ${typeof filterValue}`, { 'operator': 'BOOLEAN.NOT_EQUALS' });
    }
  ...
  static handleNotIdentical(value: FilterValueEntity.Type, filterValue: FilterValueEntity.Type) {
    ...
    if (typeof filterValue !== 'boolean') {
      throw new FilterOperatorError(`BOOLEAN.NOT_IDENTICAL requires filter value to be a boolean, got ${typeof filterValue}`, { 'operator': 'BOOLEAN.NOT_IDENTICAL' });
    }
