...
export class DateOperators {
  ...
  static handleBetween(value: FilterValueEntity.Type, filterValue: FilterValueEntity.Type) {
    ...
    if (!Predicates.isPlainObject(filterValue)) {
      throw new FilterOperatorError('DATE.BETWEEN requires filter value to be an object with min and max properties', { 'operator': 'DATE.BETWEEN' });
    }
    ...
    if (start === null || end === null) {
      throw new FilterOperatorError('DATE.BETWEEN requires valid min and max date values', { 'operator': 'DATE.BETWEEN' });
    }
  ...
  static handleEquals(value: FilterValueEntity.Type, filterValue: FilterValueEntity.Type) {
    ...
    if (date1 === null) {
      throw new FilterOperatorError(`DATE.EQUALS requires value to be a valid date, got ${typeof value}`, { 'operator': 'DATE.EQUALS' });
    }
    if (date2 === null) {
      throw new FilterOperatorError(`DATE.EQUALS requires filter value to be a valid date, got ${typeof filterValue}`, { 'operator': 'DATE.EQUALS' });
    }
  ...
  static handleOutside(value: FilterValueEntity.Type, filterValue: FilterValueEntity.Type) {
    ...
    if (!Predicates.isPlainObject(filterValue)) {
      throw new FilterOperatorError('DATE.OUTSIDE requires filter value to be an object with min and max properties', { 'operator': 'DATE.OUTSIDE' });
    }
    ...
    if (start === null || end === null) {
      throw new FilterOperatorError('DATE.OUTSIDE requires valid min and max date values', { 'operator': 'DATE.OUTSIDE' });
    }
