...
const runnerMap: ScenarioRunnerMap = {
  ...
  'snapshot-metadata-and-transports': () => {
  ...
  'fanout-onTransportError-throws': () => {
    const received: number[] = [];
  ...
  'onTransportError-detached-cause': () => {
  ...
  'onTransportError-fanout-continues': () => {
