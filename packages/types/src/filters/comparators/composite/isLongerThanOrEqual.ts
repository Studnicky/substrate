...
/**
 * Checks if a value's length, size, or magnitude is greater than or equal to the specified threshold
 ...
 */
export function isLongerThanOrEqual(value: unknown, threshold: number): boolean {
  // Strings and arrays
