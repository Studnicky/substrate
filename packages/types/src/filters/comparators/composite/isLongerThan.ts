/**
 * Checks if a value's length/size/magnitude is longer/greater than a threshold
 */
...
/**
 * Checks if a value's length, size, or magnitude is greater than the specified threshold
 * @param value - The value to check
 * @param threshold - The threshold to compare against
 * @returns true if value's length/size/magnitude is greater than threshold, false otherwise
 *
 * Supported types:
 ...
 */
export function isLongerThan(value: unknown, threshold: number): boolean {
  // Strings and arrays
