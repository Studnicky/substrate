...
ruleTester.run('static-method-verbs (any mode)', staticMethodVerbs, {
  valid: [
    {
...
ruleTester.run('static-method-verbs (structural mode)', staticMethodVerbs, {
  valid: [
    {
...
typedRuleTester.run('static-method-verbs (typed mode)', staticMethodVerbs, {
  valid: [
    {
...
(['any', 'structural', 'typed'] as const).forEach((mode) => {
  ...
  tester.run(`static-method-verbs (module-scope gating, ${mode} mode)`, staticMethodVerbs, {
    valid: [
      {
