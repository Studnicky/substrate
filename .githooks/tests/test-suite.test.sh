...
JSON
  ...
  : > packages/foo/tests/unit/foo.loop.spec.ts
  : > packages/foo/tests/integration/foo.loop.spec.ts
  ...
  assert_contains "runner unit file" "packages/foo/tests/unit/foo.loop.spec.ts" "$out"
